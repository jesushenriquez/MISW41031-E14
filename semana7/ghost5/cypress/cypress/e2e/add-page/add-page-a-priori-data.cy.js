...
describe('Add Page', function() {
    ...
    const pageDataLongDescription = [
        ...
        { 
            ...
            image: 'https://source.unsplash.com/random',
            youtube: 'https://www.youtube.com/watch?v=video4'
        },
        { 
            ...
            image: 'https://source.unsplash.com/random',
            youtube: 'https://www.youtube.com/watch?v=video5'
        },
        { 
            ...
            image: 'https://source.unsplash.com/random',
            youtube: 'https://www.youtube.com/watch?v=video6'
        },
        { 
            ...
            image: 'https://source.unsplash.com/random',
            youtube: 'https://www.youtube.com/watch?v=video7'
        },
        { 
            ...
            image: 'https://source.unsplash.com/random',
            youtube: 'https://www.youtube.com/watch?v=video8'
        },
        { 
            ...
            image: 'https://source.unsplash.com/random',
            youtube: 'https://www.youtube.com/watch?v=video9'
        },
        { 
            ...
            image: 'https://source.unsplash.com/random',
            youtube: 'https://www.youtube.com/watch?v=video10'
        }
    ];
    ...
    pageDataWithYoutube.forEach((data) => {
        it('Registrar y Publicar una nueva page con Imagen destacada, un texto de al menos 1000 caracteres y un video de youtube.', function() {
            let screen = screenshot.bind(null, "Add Page", "Registrar y Publicar una nueva page con Imagen destacada, un texto de al menos 1000 caracteres y un video de youtube.");
            signIn();
            screen("Paso 1");
            ...
            screen("Paso 4");
            cy.get('div[data-placeholder="Begin writing your page..."]').type(`${data.description}{enter}`);
            screen("Paso 5");
            cy.get('div[data-placeholder="Begin writing your page..."]').type(`/youtube ${data.youtube}{enter}`);
            screen("Paso 6");
