...
describe('Add Page', function() {
   ...
   */
    pageData.forEach((data, i) => {
        it('Registrar y publicar una nueva pagina', function() {
            let screen = screenshot.bind(null, "Add Page", "Registrar y publicar una nueva pagina con imagen" + i);
            signIn();
            screen("Paso 1");
            page.clickPageLink();
            screen("Paso 2");
   ...
   * -------------------------------------------------------------
   */
    pageDataWithYoutube.forEach((data, i) => {
        it('Registrar y Publicar una nueva page con un texto de al menos 1000 caracteres y un video de youtube.', function() {
            let screen = screenshot.bind(
                null,
                "Add Page",
                "Registrar y Publicar una nueva page con un texto de al menos 1000 caracteres y un video de youtube " +
                i
            );
   ...
   * -------------------------------------------------------------
   */
    pageDataLongDescription.forEach((data, i) => {
        
        it('Registrar y Publicar una nueva page con un texto de al menos 10000 caracteres y un video de youtube.', function() {
            let screen = screenshot.bind(
              null,
              "Add Page",
              "Registrar y Publicar una nueva page con un texto de al menos 10000 caracteres y un video de youtube. " +
                i
            );
            signIn();
            screen("paso1");
        ...
        cy.fixture('pages.json').then((pages)=>{
            for (let index = 0; index < 2; index++) {
                ...
                let screen = screenshot.bind(
                    null,
                    "Edit Page",
                    "Editar la información de una pagina existente " + index
                );
        ...
        cy.fixture('pages.json').then((pages)=>{
            for (let index = 22; index < 25; index++) {
                ...
                let screen = screenshot.bind(
                  null,
                  "Edit Page",
                  "Editar la información de una pagina existente sin titulo " +
                    index
                );
